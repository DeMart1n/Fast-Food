...
public static void imprimirPedido(Pedido pedido) {
    ...
    if (pedido.getLanche() != null) {
        System.out.println("Lanche: " + pedido.getLanche().getNome() + " - R$" + pedido.getLanche().getPreço());
    } else {
    ...
    if (pedido.getBebida() != null) {
        System.out.println("Bebida: " + pedido.getBebida().getNome() + " - R$" + pedido.getBebida().getPreço());
    } else {
